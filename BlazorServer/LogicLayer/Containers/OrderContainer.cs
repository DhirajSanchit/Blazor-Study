...
namespace LogicLayer.Containers
{
    public class OrderContainer : IOrderContainer
    {
        ...
        public OrderContainer(IDataAccess dataAccess)
        {
        ...
        public IEnumerable<LineItem> GetLineItemsByOrderId(int orderId)
        {
            var sql = "SELECT * FROM OrderLineItem WHERE OrderId = @OrderId";
            var lineItems = dataAccess.Query<LineItem, dynamic>(sql, new { OrderId = orderId });
        ...
        IEnumerable<LineItem> IOrderContainer.GetLineItemsByOrderId(int id)
        {
            throw new NotImplementedException();
        }
        ...
        public void UpdateOrder(Order order)
        {
            ...
            dataAccess.ExecuteCommand<List<LineItem>>(sql, order.LineItems);
        }
    }
}
